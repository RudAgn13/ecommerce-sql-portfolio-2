...
## SQL Concepts
Window functions (NTILE, ROW_NUMBER, LAG, RANK), multi-level CTEs, conditional aggregation,
cohort analysis, funnel analysis, composite scoring, FULL OUTER JOIN attribution modelling,
date arithmetic, NULLIF safe division.
